...
static int EX_FLD_GMC_LIGHT_ADD()
{
  DEBUG_LOG("Running FLD_GMC_LIGHT_ADD\n");
  return FLD_GMC_LIGHT_ADD();
}

static int EX_FLD_GMC_LIGHT_GET_UID()
{
  DEBUG_LOG("Running FLD_GMC_LIGHT_GET_UID\n");
  return FLD_GMC_LIGHT_GET_UID();
}

static int EX_FLD_GMC_LIGHT_CTRL()
{
  DEBUG_LOG("Running FLD_GMC_LIGHT_CTRL\n");
